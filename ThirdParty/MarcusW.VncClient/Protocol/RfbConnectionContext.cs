...
namespace MarcusW.VncClient.Protocol
{
    ...
    public class RfbConnectionContext
    {
        ...
        public class ConnectionDetailsAccessor
        {
            ...
            /// <summary>
            /// Sets the value of the <seealso cref="RfbConnection.ServerSupportsExtendedClipboard"/> property on the <see cref="RfbConnection"/> object.
            /// </summary>
            /// <param name="serverSupportsExtendedClipboard">The new state.</param>
            public void SetServerSupportsExtendedClipboard(bool serverSupportsExtendedClipboard) =>
                _connection.ServerSupportsExtendedClipboard = serverSupportsExtendedClipboard;
        }
    }
}

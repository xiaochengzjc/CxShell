...
namespace MarcusW.VncClient
{
    ...
    public sealed class ConnectParameters : FreezableParametersObject
    {
        ...
        private string _encodingProfile = "Compatibility";
        ...
        /// <summary>
        /// Gets or sets the preferred encoding profile used for the initial SetEncodings message.
        /// Supported values are Compatibility, Performance, Quality, and Raw.
        /// </summary>
        public string EncodingProfile
        {
            get => _encodingProfile;
            set => ThrowIfFrozen(() => _encodingProfile = string.IsNullOrWhiteSpace(value) ? "Compatibility" : value);
        }
        ...
        public override void Validate()
        {
            ...
            if (string.IsNullOrWhiteSpace(EncodingProfile))
                throw new ConnectParametersValidationException($"{nameof(EncodingProfile)} parameter must not be empty.");
